...
import com.zippyboot.infra.storage.service.impl.DefaultStorageService;
import com.zippyboot.infra.storage.spi.StorageBackend;
import com.zippyboot.infra.storage.spi.impl.LocalStorageBackend;
import com.zippyboot.infra.storage.spi.impl.S3StorageBackend;
...
@AutoConfiguration
@ConditionalOnProperty(prefix = "zippyboot.storage", name = "enabled", havingValue = "true", matchIfMissing = true)
...
public class StorageAutoConfiguration {
    ...
    @ConditionalOnProperty(prefix = "zippyboot.infra.storage", name = "type", havingValue = "S3")
