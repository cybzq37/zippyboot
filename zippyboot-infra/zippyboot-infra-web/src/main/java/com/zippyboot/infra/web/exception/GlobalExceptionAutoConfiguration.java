package com.zippyboot.infra.web.exception;
...
@ConditionalOnProperty(prefix = "zippyboot.global.web.exception", name = "enabled", havingValue = "true", matchIfMissing = true)
