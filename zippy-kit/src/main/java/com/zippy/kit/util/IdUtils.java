...
public final class IdUtils {
    ...
    private static final String WORKER_ID_KEY = "zippy.id.worker-id";
    private static final String DATACENTER_ID_KEY = "zippy.id.datacenter-id";
