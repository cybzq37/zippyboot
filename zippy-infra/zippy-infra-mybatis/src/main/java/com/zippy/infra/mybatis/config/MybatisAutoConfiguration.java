...
import com.zippy.infra.mybatis.handler.JsonTypeHandler;
import com.zippy.infra.mybatis.handler.PgJsonbTypeHandler;
import com.zippy.infra.mybatis.interceptor.PageableInterceptor;
 ...
 * <pre>
 * mybatis-plus:
 *   type-handlers-package: com.zippy.infra.mybatis.handler
 *   configuration:
...
@ConditionalOnProperty(prefix = "zippy.mybatis", name = "enabled", havingValue = "true", matchIfMissing = true)
